...
from CTAFlow.models.evaluation.ng_live import (
    DailyContextPaths,
    NatGasLiveInterface,
    ng_default_config,
)
...
def build_s3_source():
    from CTAFlow.data.storage.aws_client import S3Config
    from CTAFlow.data.ext.s3_client import S3TickerSpec, S3TickDataSource
...
def build_gcs_source():
    from CTAFlow.data.ext.gcs_client import GCSConfig, GCSTickerSpec, GCSTickDataSource
