...
__all__ = ["OrderflowParams", "OrderflowScanner", "orderflow_screen"]
...
def orderflow_screen(
    ...
    Examples:
        # Simple scan
        results = orderflow_screen(tick_data, params)
...
def main(argv: Optional[Sequence[str]] = None) -> None:
    ...
    scan_results = orderflow_screen(tick_data, params)
